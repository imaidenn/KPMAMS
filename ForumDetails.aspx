                    ...
                    <div class="panel-body">
                        <div class="row d-flex">
                            <div class="col-md-10 form-group">
                                ...
                                <asp:TextBox ID="tbTitle" style="font-size: 1.17em; font-weight: bolder" class="form-control" runat="server" Visible="false" placeholder="Title of forum" AutoCompleteType="Disabled" ></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                <div class="dropdown">
                            ...
                            <div class="col-md-12">
                                <p>
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox ID="tbContent" CssClass="form-control" Visible="false" TextMode="MultiLine" placeholder="Contents of forum" Rows="5" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label>Comment :</label>
                                <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="tbComment" runat="server" TextMode="MultiLine" placeholder="Contents of comment" Rows="5" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
