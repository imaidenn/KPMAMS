<%@ Page Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="Homepage.aspx.cs" Inherits="KPMAMS.Homepage" %>
                              ...
                              <table class="table table-striped table-bordered table-hover">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>
                                          <em class="fa fa-calendar fa-fw text-muted"></em>05/05/2017</td>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <em class="fa fa-calendar fa-fw text-muted"></em>15/05/2017</td>
                                       <td class="text-center">
                                          <div class="btn-group"><a href="javascript:void(0);" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-cog"></i></a>
                                             <ul class="dropdown-menu pull-right text-left">
                                                <li><a href="javascript:void(0);">Action</a>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <em class="fa fa-calendar fa-fw text-muted"></em>05/10/2017</td>
                                       <td class="text-center">
                                          <div class="btn-group"><a href="javascript:void(0);" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-cog"></i></a>
                                             <ul class="dropdown-menu pull-right text-left">
                                                <li><a href="javascript:void(0);">Action</a>
