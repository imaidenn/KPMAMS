<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="TimetableDetails_Admin.aspx.cs" Inherits="KPMAMS.Admin.TimetableDetails_Admin" %>
                ...
                <div class="panel">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="dropdown">
                                    <asp:LinkButton ID="lbMenu" CssClass="btn btn-info btn-block dropdown-toggle" role="button" type="button" data-toggle="dropdown" runat="server">More<i style="margin-left:10px;" class="fas fa-caret-down"></i></asp:LinkButton>
                                    <div class="dropdown-menu text-center">
                                        <asp:LinkButton ID="lbModify" CssClass="dropdown-item" runat="server">Modify</asp:LinkButton>
